[Lighthouse](https://developers.google.com/web/tools/lighthouse) is a tool that comes with Chrome, which we often use to analyze a website for performance, SEO, best practices, etc. 
